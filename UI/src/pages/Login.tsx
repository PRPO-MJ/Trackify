...
const REDIRECT_URI = "https://api.trackify.zusidelavi.com/api/auth/google/callback";
    ...
    <div className="min-h-screen flex items-center justify-center bg-background p-4">
      <div className="w-full max-w-md animate-scale-in">
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-2xl font-bold tracking-tight">Trackify</h1>
          <p className="text-muted-foreground mt-1">Track your hours, achieve your goals</p>
        </div>
